...
import edu.utdallas.mavs.evacuation.simulation.sim.agent.planning.HumanPlanningModule;
 ...
 * Human Agent
 */
public class HumanAgent extends AbstractAgent<EHumanAgentState, EvacuationHumanKnowledgeModule, HumanInteractionModule, HumanPlanningModule, HumanTaskModule> implements Serializable
{
    public HumanAgent(EHumanAgentState state)
    {
        super(state);
    }
    ...
    @Override
    protected HumanPlanningModule createPlanningModule(EvacuationHumanKnowledgeModule knowledgeModule, HumanTaskModule taskModule, HumanInteractionModule humanInteractionModule)
    {
        ...
        return new HumanPlanningModule(planGenerator, planExecutor, knowledgeModule, reactionModule);
    }
